        ...
        <div
            ...
            <div className="flex gap-10">
                <div className="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    <a to="/users" className="flex gap-4">
                ...
                <div className="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    <a to="/todos" className="flex gap-4">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Todo List Manager</h5>
                        <ClipboardListIcon
                            className="w-8 h-8"/>
                    </a>
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Simple Todo list managers using reactjs & endapi</p>
                    <a to="/todos"
                       className="inline-flex mt-2 items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Go to todos
                        <svg className="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
